...
vlog -work xpm  -incr -mfcu  -sv -L axi_vip_v1_1_17 -L smartconnect_v1_0 -L processing_system7_vip_v1_0_19 -L xilinx_vip "+incdir+G:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
...
vlog -work blk_mem_gen_v8_4_8  -incr -mfcu  "+incdir+G:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
"../../../ipstatic/simulation/blk_mem_gen_v8_4.v" \

vlog -work xil_defaultlib  -incr -mfcu  "+incdir+G:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
